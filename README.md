...
This sample uses [auth0/jwt-auth-bundle](https://github.com/auth0/jwt-auth-bundle) to implement the following security tasks:
...
With the `.env.local` configuration values set, run the API server by issuing the following command:
